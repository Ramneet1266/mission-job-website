...
export default function Information() {
  ...
  const { data: cardData = [], error } = useSWR("cards", fetchCards, {
  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-red-700 text-lg">Failed to load data</div>
      </div>
    )
  }
              ...
              >
                <div className="relative w-full h-56">
                  <img
                    ...
                    onError={(e) => console.error("Image load error:", card.image, e)}
                  />
                  <button
              ...
              <div className="flex min-h-full items-center justify-center p-4">
                ...
                >
                  <Dialog.Panel className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-2xl">
                    ...
                    <p className="text-gray-600 text-sm my-6">{selectedCard?.description}</p>
