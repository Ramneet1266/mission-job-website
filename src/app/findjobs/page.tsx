...
export default function JobFilterBar() {
    ...
    useEffect(() => {
        ...
        setFilters((prev) => ({
            ...
            city: city !== "All" ? decodeURIComponent(city) : "All",
            company: company !== "All" ? decodeURIComponent(company) : "All",
            tags: tag ? [decodeURIComponent(tag)] : [],
        }))
    }, [searchParams])
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // Include URL-provided tag in availableTags to ensure it’s selectable
    ...
    const filteredJobs = jobs.filter((job) => {
        ...
        const matchesTags =
            filters.tags.length === 0 || filters.tags.every((tag) => job.tags.includes(tag))
        ...
        <div className="mt-20 h-[calc(100vh-2rem)] bg-gradient-to-br from-blue-50 to-white">
                ...
                <div className="flex gap-2 flex-wrap justify-center">
                    {([
                        ...
                        },
                        {
                            label: "Salary",
                            key: "salary",
                            options: ["All", "Rs 0 - 20000", "Rs 20000 - 40000", "Rs 40000+"],
                        },
                        {
                            label: "Companies",
                            key: "company",
            ...
            <div className="flex h-full">
                ...
                <div className="w-1/2 border-r-2 border-blue-200 overflow-y-auto p-4 space-y-3 bg-white rounded-l-md shadow-md">
                    {loading ? (
                        <p className="text-center text-blue-600 font-medium animate-pulse"></p>
                    ) : error ? (
