...
export default function JobFilterBar() {
  ...
  useEffect(() => {
    const filteredJobs =
      filters.category === "All" ? jobs : jobs.filter((job) => job.category === filters.category)
          ...
          {selectedJob ? (
            user ? (
              <div className="space-y-3">
                ...
                <button
                  className="w-full px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-all duration-200 shadow-md"
                >
                  Quick Apply
                </button>
              </div>
